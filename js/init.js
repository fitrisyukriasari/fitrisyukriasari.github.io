...
$(document).ready(function(){
  ...
  $('body').niceScroll({cursorcolor:"#279eda",cursorborder:"1px solid #279eda"});
...
function porky(){
	...
	$("#title").typed({
		strings: ["Assalamu'alaikum", "Hai, teman-teman", "Apa kabar ?"],
		typeSpeed: 300,
		backDelay: 900,
		loop: true,
		cursorChar: "|",
